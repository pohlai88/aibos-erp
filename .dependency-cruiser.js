module.exports = {
  forbidden: [
    ...
    // Forbid deep imports into package internals from outside packages
    {
      ...
      comment:
        "Consumers must import package public API (package root / index.ts)",
    },
    ...
    // Forbid circular dependencies
    {
      ...
      comment:
        "Circular dependencies are not allowed except in entity relationships",
    },
    ...
    // Forbid orphaned modules
    {
      ...
      to: {},
      comment:
        "Orphaned files are allowed in build outputs and configuration files",
    },
